...
#
#              for k in range(r - s):           r - s should = r - s + 1
#                  count = 0                    belongs before loop
#                  if math.cos(r) > 0:          math.cos(r + k)
